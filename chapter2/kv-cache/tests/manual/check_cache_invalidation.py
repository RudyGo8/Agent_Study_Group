...
def test_cache_invalidation():
    ...
    if len(metrics_correct.ttft_per_iteration) > 2:
        ...
        if avg_rest < first_ttft * 0.7:  # 至少改善 30%
    ...
    if len(metrics_dynamic.ttft_per_iteration) > 2:
        ...
        if (max_ttft - min_ttft) / max_ttft < 0.3:  # 波动小于 30%
